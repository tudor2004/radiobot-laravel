...
/**
 * Class AudioAddYoutubeTrack
 */
class AudioAddYoutubeTrack implements CommandContract
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '!audio add youtube track https:\/\/(.+)';
    }
    ...
    public function handle(string $command): string
    {
        ...
        {
            return 'Track added to track list: ' . PHP_EOL . implode(PHP_EOL, $addedTracks);
        }

        return 'Track could not be added to track list.';
    }
